...
const filePath = path.join(__dirname, 'kasa_raporu.html');
let html = fs.readFileSync(filePath, 'utf8');

const newMainContent = `
    <main class="main-content">
        <h2 class="page-title">Kasa Raporu</h2>

        <div class="mb-20" style="display: flex; gap: 10px; flex-wrap: wrap;">
            <a href="kasa.html" class="btn btn-dark-blue p-20 mb-10" style="background: linear-gradient(135deg, #1f3a60 0%, #112240 100%); font-size: 15px; border: none; cursor: pointer;">
                <i class="fa-solid fa-arrow-left"></i> Kasa Özetine Dön
            </a>
            <button id="btnGetReport" class="btn btn-dark-blue p-20 mb-10" style="background: linear-gradient(135deg, #34495e 0%, #2c3e50 100%); font-size: 15px; border: none; cursor: pointer;">
                <i class="fa-solid fa-cash-register"></i> Raporu Hazırla
            </button>
        </div>
        ...
        <div class="selection-section">
            ...
            <div class="content-box">
                <div class="filter-row" style="display: flex; gap: 40px; align-items: flex-end; background-color: #f7f9fa; padding: 15px; border-radius: 8px; border: 1px solid #ebf0f4; flex-wrap: wrap;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 5px;">
                        <label style="font-size: 13px; font-weight: bold; color: #555;">İşlem Türü Seçiniz:</label>
                        <select class="form-control" id="islemTuru" style="border-radius: 8px; border: 1px solid #dce0e4; padding: 8px 12px; height: 40px; width: 220px;">
                            <option value="all">Tüm Nakit İşlemler</option>
                            <option value="in">Nakit Tahsilat</option>
                            <option value="out">Nakit Tediye</option>
                        </select>
                    </div>
                            ...
                            <tbody id="reportTableBody">
                                <tr>
                                    <td colspan="5" style="padding: 40px; text-align: center; color: #888; font-style: italic;">
                                        Seçilen kriterlere uygun kasa hareketi bulunamadı.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
// Fallback if there was no btnGetReport
...
console.log('Successfully modernized kasa_raporu.html');
