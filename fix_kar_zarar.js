...
const filePath = path.join(__dirname, 'kar_zarar_analizi.html');
let html = fs.readFileSync(filePath, 'utf8');

const newMainContent = `
    <main class="main-content">
        <h2 class="page-title">Kâr Zarar Analizi</h2>
        ...
        <div class="mb-20" style="display: flex; gap: 10px; flex-wrap: wrap;">
            ...
            <button id="btnGetReport" class="btn btn-dark-blue p-20 mb-10" style="background: linear-gradient(135deg, #34495e 0%, #2c3e50 100%); font-size: 15px; border: none; cursor: pointer;">
                <i class="fa-solid fa-scale-balanced"></i> Analizi Hazırla
            </button>
        </div>

        <div class="selection-section">
            <div class="section-header bg-gray-header">
                <i class="fa-solid fa-chart-line"></i> Analiz Kriterleri
            </div>
                        ...
                        <table class="customer-table w-100">
                            <thead>
                                <tr class="bg-gray-header">
                                    <th class="p-15" style="border-radius: 8px 0 0 0;">Gelir Kalemi</th>
                                    <th>Gelir Tutarı</th>
                                    <th>Gider Kalemi</th>
                                    <th>Gider Tutarı</th>
                                    <th style="border-radius: 0 8px 0 0;">Net Durum</th>
                                </tr>
                            </thead>
                            <tbody id="reportTableBody">
                                <tr>
                                    <td colspan="5" style="padding: 40px; text-align: center; color: #888; font-style: italic;">
                                        Kâr zarar tabloları henüz oluşturulmadı.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
console.log('Successfully modernized kar_zarar_analizi.html');
