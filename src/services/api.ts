...
api.interceptors.request.use((config) => {
    ...
    // Always add the header to bypass localtunnel warning page
...
export const dealService = {
    ...
    create: async (deal: any) => {
        const { data } = await api.post('/api/deals', {
            ...
            expected_closing_date: deal.expectedClosingDate || deal.endDate,
            stage: deal.stage,
            probability: deal.probability,
            expected_revenue: deal.expectedRevenue || deal.amount,
    ...
    update: async (id: string, updates: any) => {
        const { data } = await api.put(`/api/deals/${id}`, {
            ...
            expected_closing_date: updates.expectedClosingDate || updates.endDate,
            stage: updates.stage,
            probability: updates.probability,
            expected_revenue: updates.expectedRevenue || updates.amount,
            currency: updates.currency,
