...
const filePath = path.join(__dirname, 'cari_raporu.html');
let html = fs.readFileSync(filePath, 'utf8');

const newMainContent = `
    <main class="main-content">
        <h2 class="page-title">Cari Raporu</h2>

        <div class="mb-20" style="display: flex; gap: 10px; flex-wrap: wrap;">
            <a href="cari_hesaplar.html" class="btn btn-dark-blue p-20 mb-10" style="background: linear-gradient(135deg, #1f3a60 0%, #112240 100%); font-size: 15px; border: none; cursor: pointer;">
                <i class="fa-solid fa-arrow-left"></i> Cari Hesaplara Dön
            </a>
            <button id="btnGetReport" class="btn btn-dark-blue p-20 mb-10" style="background: linear-gradient(135deg, #34495e 0%, #2c3e50 100%); font-size: 15px; border: none; cursor: pointer;">
                <i class="fa-solid fa-users"></i> Raporu Hazırla
            </button>
        </div>
        ...
        <div class="selection-section">
            ...
            <div class="content-box">
                <div class="filter-row" style="display: flex; gap: 40px; align-items: flex-end; background-color: #f7f9fa; padding: 15px; border-radius: 8px; border: 1px solid #ebf0f4; flex-wrap: wrap;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 5px;">
                        <label style="font-size: 13px; font-weight: bold; color: #555;">Cari Tipi:</label>
                        <select class="form-control" id="cariTipi" style="border-radius: 8px; border: 1px solid #dce0e4; padding: 8px 12px; height: 40px; width: 220px;">
                            <option value="all">Tüm Cariler</option>
                            <option value="alici">Sadece Alıcılar (Müşteri)</option>
                            <option value="satici">Sadece Satıcılar (Tedarikçi)</option>
                        </select>
                    </div>
                        ...
                        <table class="customer-table w-100">
                            <thead>
                                <tr class="bg-gray-header">
                                    <th class="p-15" style="border-radius: 8px 0 0 0;">Cari Kodu</th>
                                    <th>Unvan / Ad Soyad</th>
                                    <th>Cari Tipi</th>
                                    <th>Borç Bakiyesi</th>
                                    <th style="border-radius: 0 8px 0 0;">Alacak Bakiyesi</th>
                                </tr>
                            </thead>
                            <tbody id="reportTableBody">
                                <tr>
                                    <td colspan="5" style="padding: 40px; text-align: center; color: #888; font-style: italic;">
                                        Seçilen kriterlere uygun cari hareket bulunamadı.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
console.log('Successfully modernized cari_raporu.html');
